...
class GithubFormRea extends Component {
    ...
    findUser() {
        ...
        window.localStorage.setItem("github-login-rea", this.state.inputValue)
    ...
    selectRepo(e) {
        ...
        window.localStorage.setItem("selectedRepoRea", e.value)
        window.localStorage.setItem("github-login-rea", this.state.logins[i])
    }
